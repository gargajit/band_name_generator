...
app.post("/submit", (req,res) => {
  var adjRandomNumber = Math.floor(adj.length * Math.random());
  var randomAdj = adj[adjRandomNumber];

  var nounRandomNumber = Math.floor(noun.length * Math.random());
  var randomNoun = noun[nounRandomNumber];
